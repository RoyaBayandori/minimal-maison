...
require MM_THEME_DIR . '/inc/date.php';
...
require MM_THEME_DIR . '/inc/cpt/creation-categories.php';
require MM_THEME_DIR . '/inc/cpt/testimonials.php';
require MM_THEME_DIR . '/inc/cpt/custom-order-faq.php';
require MM_THEME_DIR . '/inc/acf.php';
require MM_THEME_DIR . '/inc/portfolio-gallery-ajax.php';
