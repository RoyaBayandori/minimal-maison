		...
		array(
			...
			'fields'                => array(
				...
				array(
					...
					'label' => __( 'Call To Action', 'minimal-maison' ),
					'type'  => 'tab',
				),
				array(
					'key'   => 'field_mm_cta_title',
					'label' => __( 'CTA Title', 'minimal-maison' ),
					'name'  => 'cta_title',
					'type'  => 'textarea',
					'rows'  => 3,
				),
				array(
					...
					'label' => __( 'CTA Description', 'minimal-maison' ),
					'name'  => 'cta_description',
					'type'  => 'textarea',
					'rows'  => 3,
				),
				array(
					'key'           => 'field_mm_cta_image',
					'label'         => __( 'CTA Image', 'minimal-maison' ),
					'name'          => 'cta_image',
					'type'          => 'image',
					'return_format' => 'id',
					'preview_size'  => 'medium',
				...
				array(
					'key'   => 'field_mm_cta_button_text',
					'label' => __( 'CTA Button Text', 'minimal-maison' ),
					'name'  => 'cta_button_text',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_mm_cta_button_url',
					'label' => __( 'CTA Button URL', 'minimal-maison' ),
					'name'  => 'cta_button_url',
					'type'  => 'text',
				),
			),
